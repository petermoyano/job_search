...
ROMINA_ORDERED_SOURCES = [
    ...
    SearchSource(
        id="jobspresso", label="Jobspresso", domains=["jobspresso.co"], order=4,
        max_results=10, acquisition_mode=AcquisitionMode.jobspresso_wp_rest,
        attribution_url="https://jobspresso.co",
    ),
    SearchSource(
        id="randstad_ar", label="Randstad Argentina",
        domains=["randstad.com.ar"], order=5, max_results=10,
        acquisition_mode=AcquisitionMode.randstad_html,
        attribution_url="https://www.randstad.com.ar",
    ),
    SearchSource(id="linkedin", label="LinkedIn Jobs", domains=["linkedin.com"], order=6),
    SearchSource(id="computrabajo_ar", label="Computrabajo Argentina", domains=["ar.computrabajo.com"], order=7),
    SearchSource(id="bumeran", label="Bumeran", domains=["bumeran.com.ar"], order=8),
    SearchSource(id="getonboard", label="Get On Board", domains=["getonbrd.com"], order=9),
    SearchSource(id="hiringroom", label="Hiring Room", domains=["hiringroom.com"], order=10),
    SearchSource(id="torre", label="Torre", domains=["torre.ai"], order=11),
    SearchSource(id="remote_latam", label="Remote Latam", domains=["remolatam.com"], order=12),
    SearchSource(id="jobgether", label="Jobgether", domains=["jobgether.com"], order=13),
    SearchSource(id="zonajobs", label="Zonajobs", domains=["zonajobs.com.ar"], order=14, enabled=False),
    SearchSource(id="indeed_es", label="Indeed España", domains=["es.indeed.com"], order=15, enabled=False),
    SearchSource(id="infojobs", label="InfoJobs", domains=["infojobs.net"], order=16, enabled=False),
    SearchSource(id="wellfound", label="Wellfound", domains=["wellfound.com"], order=17, enabled=False),
    SearchSource(id="workana_hr", label="Workana - RRHH", domains=["workana.com"], order=18, enabled=False),
    SearchSource(id="talent", label="Talent.com", domains=["talent.com"], order=19, enabled=False),
    SearchSource(id="jooble", label="Jooble", domains=["jooble.org", "ar.jooble.org"], order=20, enabled=False),
    SearchSource(id="multitrabajos", label="Multitrabajos", domains=["multitrabajos.com"], order=21, enabled=False),
    SearchSource(id="adecco_ar", label="Adecco Argentina", domains=["adecco.com.ar"], order=22, enabled=False),
