...
ROMINA_ORDERED_SOURCES = [
    ...
    SearchSource(
        id="linkedin", label="LinkedIn Jobs", domains=["linkedin.com"], order=6
    ),
    SearchSource(
        id="computrabajo_ar",
    ...
    SearchSource(
        id="getonboard", label="Get On Board", domains=["getonbrd.com"], order=9
    ),
    SearchSource(
        id="hiringroom", label="Hiring Room", domains=["hiringroom.com"], order=10
    ),
    SearchSource(id="torre", label="Torre", domains=["torre.ai"], order=11),
    SearchSource(
        id="remote_latam", label="Remote Latam", domains=["remolatam.com"], order=12
    ),
    SearchSource(
        id="jobgether", label="Jobgether", domains=["jobgether.com"], order=13
    ),
    SearchSource(
        id="zonajobs",
        label="Zonajobs",
        domains=["zonajobs.com.ar"],
        order=14,
        enabled=False,
    ),
    SearchSource(
    ...
    SearchSource(
        id="talent", label="Talent.com", domains=["talent.com"], order=19, enabled=False
    ),
    SearchSource(
        id="jooble",
        label="Jooble",
    ...
    SearchSource(
        id="multitrabajos",
        label="Multitrabajos",
        domains=["multitrabajos.com"],
        order=21,
        enabled=False,
    ),
    SearchSource(
        id="adecco_ar",
        label="Adecco Argentina",
        domains=["adecco.com.ar"],
        order=22,
        enabled=False,
    ),
    SearchSource(
        id="manpower_ar",
        label="Manpower Argentina",
        domains=["manpower.com.ar"],
        order=23,
        enabled=False,
    ),
    SearchSource(
        id="michael_page_ar",
        label="Michael Page Argentina",
        domains=["michaelpage.com.ar"],
        order=24,
        enabled=False,
    ),
    SearchSource(
...
ROMINA_ROLE_TIERS = [
    RoleTier(
        ...
        titles=[
            ...
            "People Partner",
            "Socio de Personas",
            "Líder de Adquisición y Gestión de Talento",
    ...
    RoleTier(
        ...
        titles=[
            ...
            "Especialista en Marca Empleadora",
            "Referente de Cultura Organizacional",
            "Consultor en RRHH",
            "Consultora en RRHH",
        ],
    ),
    RoleTier(
        ...
        titles=[
            ...
            "Analista de Clima y Cultura Laboral",
            "Asesor Legal-Laboral",
            "Asesora Legal-Laboral",
            "Especialista en Compensaciones y Beneficios",
            "Consultor de Talento Freelance",
            "Consultora de Talento Freelance",
            "Headhunter",
